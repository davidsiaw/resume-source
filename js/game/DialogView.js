function DialogView(x,y,z,w,h,windowSkin)
{
    ...
    this.modeBottomDialog = function()
    {
    	th = 160;
    	tw = w-8;
    	tx = 4;
    ...
    this.modeStatusDialog = function()
    {
    	th = 64;
    	tw = w-8;
    	tx = 4;
    ...
    this.hideHighlightBox = function()
    {
    	highlightbox = {
		    x: 0,
		    y: 0,
